...
myImg.addEventListener('click', function() {
    ...
    if (mySrc === "Images/Logo-rolling-out-dough.png"){
        myImg.setAttribute('src', "Images/Logo-rolling-out-dough-2.png");
        alert("You hungry little thing !");
    } else {
      myImg.setAttribute('src', "Images/Logo-rolling-out-dough.png");
